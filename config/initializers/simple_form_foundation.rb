...
SimpleForm.setup do |config|
  ...
  config.wrappers :horizontal_form, tag: 'div', class: 'form-horizontal__row', hint_class: :field_with_hint, error_class: :error do |b|
    ...
    b.wrapper :right_input_wrapper, tag: :div, class: 'form-horizontal__input-wrapper waffles' do |ba|
      ba.use :input
  ...
  config.wrappers :credit_card_verification_digits, tag: false, hint_class: :field_with_hint, error_class: :error do |b|
    ...
    b.use :hint,  wrap_with: { tag: :div, class: 'form-horizontal__input-hint--white' }
